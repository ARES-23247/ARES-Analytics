                ...
                Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    ...
                    Text(
                        if (mode == ProjectSetupMode.EXPLORE_DEMO) {
                            ...
                            "SIMULATION FIRST — This generic starter contains no Team 23247 season mechanisms or calibration. Build and simulation are supported; physical deployment stays blocked until Hardware Setup and commissioning evidence are complete."
                        },
                        color = AresError,
                        style = MaterialTheme.typography.bodySmall,
                        fontWeight = FontWeight.SemiBold,
