...
class AcademyPracticePackService(
    ...
    companion object {
        internal val BUNDLED_PRACTICE_FILES = linkedMapOf(
            "baseline-arm-run.csv" to """TimestampMs,Arm/PositionRad,Arm/VelocityRadPerSec,Arm/CurrentAmps,Robot/Enabled
0,0.00,0.00,0.8,false
20,0.03,1.50,2.1,true
40,0.09,3.00,3.2,true
60,0.18,4.50,4.0,true
80,0.28,5.00,4.2,true
100,0.37,4.50,3.8,true
120,0.44,3.50,3.1,true
140,0.49,2.50,2.5,true
160,0.52,1.50,1.9,true
180,0.54,1.00,1.5,true
200,0.55,0.50,1.2,true
""",
            "stalled-arm-run.csv" to """TimestampMs,Arm/PositionRad,Arm/VelocityRadPerSec,Arm/CurrentAmps,Robot/Enabled
0,0.00,0.00,0.8,false
20,0.03,1.50,2.1,true
40,0.07,2.00,3.5,true
60,0.08,0.50,7.0,true
80,0.08,0.00,10.5,true
100,0.08,0.00,12.0,true
120,0.08,0.00,12.2,true
140,0.08,0.00,12.1,true
160,0.08,0.00,0.9,false
180,0.08,0.00,0.8,false
200,0.08,0.00,0.8,false
""",
...
not simulator output. Import both files, compare position, velocity, current, and enabled state,
then write a bounded claim and identify what evidence would still be required on a real robot.
""",
        )
    }
}
