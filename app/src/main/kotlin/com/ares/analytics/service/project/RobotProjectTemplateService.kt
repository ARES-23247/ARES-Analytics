    ...
    companion object {
        ...
        val OFFICIAL_PROJECT_TEMPLATES: List<RobotProjectTemplate> = listOf(
            RobotProjectTemplate(
                id = "ares-ftc-starter-9.11.0",
                displayName = "ARES FTC Starter",
                league = League.FTC,
                aresVersion = "9.11.0",
                revision = "2997bea8b1a93b6085576603e15ae1c03412c055",
                archiveUrl = "https://github.com/ARES-23247/ARES-FTC-Starter/releases/download/v9.11.0/ARES-FTC-Starter-9.11.0.zip",
                archiveSha256 = "f3eeed0bce13f4140b389a2a6a9d9cce2f7e78526877fcb4c952942c34ce0d3a",
                bundledResourcePath = "/project-templates/ARES-FTC-Starter-9.11.0.zip",
                deploymentPolicy = RobotProjectDeploymentPolicy.HARDWARE_REVIEW_REQUIRED,
            ),
            RobotProjectTemplate(
                id = "ares-frc-starter-9.11.0",
                displayName = "ARES FRC Starter",
                league = League.FRC,
                aresVersion = "9.11.0",
                revision = "800e56d859230988bf26020165afecc304b47ff6",
                archiveUrl = "https://github.com/ARES-23247/ARES-FRC-Starter/releases/download/v9.11.0/ARES-FRC-Starter-9.11.0.zip",
                archiveSha256 = "76f33d9c99a1e6194269723ec214e27e4beaa3764a24385cbebe5aca0a161e3b",
                bundledResourcePath = "/project-templates/ARES-FRC-Starter-9.11.0.zip",
                deploymentPolicy = RobotProjectDeploymentPolicy.HARDWARE_REVIEW_REQUIRED,
            ),
        )
