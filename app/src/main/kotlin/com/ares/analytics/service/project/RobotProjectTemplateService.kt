    ...
    companion object {
        ...
        val OFFICIAL_PROJECT_TEMPLATES: List<RobotProjectTemplate> = listOf(
            RobotProjectTemplate(
                id = "ares-ftc-starter-9.12.0",
                displayName = "ARES FTC Starter",
                league = League.FTC,
                aresVersion = "9.12.0",
                revision = "11cc96d4fe0f746be60c9ea3b80c76ba1c6ac3cc",
                archiveUrl = "https://github.com/ARES-23247/ARES-FTC-Starter/releases/download/v9.12.0/ARES-FTC-Starter-9.12.0.zip",
                archiveSha256 = "971036aa0171604785788b5be90004cb0c1a1a1cc7175c1e8fa0f36fcf0a2df1",
                bundledResourcePath = "/project-templates/ARES-FTC-Starter-9.12.0.zip",
                deploymentPolicy = RobotProjectDeploymentPolicy.HARDWARE_REVIEW_REQUIRED,
            ),
            RobotProjectTemplate(
                id = "ares-frc-starter-9.12.0",
                displayName = "ARES FRC Starter",
                league = League.FRC,
                aresVersion = "9.12.0",
                revision = "d14854967fcc8545199430b44eb9ba3dfe57db8c",
                archiveUrl = "https://github.com/ARES-23247/ARES-FRC-Starter/releases/download/v9.12.0/ARES-FRC-Starter-9.12.0.zip",
                archiveSha256 = "9045990463751f2e66cd1644d479fdcf453e68ef63031675fecb8eca918fdfef",
                bundledResourcePath = "/project-templates/ARES-FRC-Starter-9.12.0.zip",
                deploymentPolicy = RobotProjectDeploymentPolicy.HARDWARE_REVIEW_REQUIRED,
            ),
        )
