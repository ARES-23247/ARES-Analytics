...
class DrivebaseAuthoringTest {
    ...
    fun `geometry and localization labs fail closed deterministically`() {
        ...
        kotlin.test.assertNotNull(turn.maxLinearSpeedMps)
        assertTrue(turn.maxLinearSpeedMps!! > 0.0)
        kotlin.test.assertNotNull(turn.maxAngularSpeedRadPerSec)
        assertTrue(turn.maxAngularSpeedRadPerSec!! > 0.0)
